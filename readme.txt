...
The basic tiles – dots, bamboos and characters – are numbered d1-d9 for dots, b1-b9 for bamboos and c1-c9 for characters.
...
The default tile images are stored in `/wp-content/plugins/mahjong-tiles/tile_images/` folder. If there's a `tile_images` folder in your theme folder (for example `/wp-content/themes/twenty-fifteen/tile_images/`, the plugin will prefer the tile images found in that folder.
...
The image tiles that come with the plugin are created by Jerry Crimson Mann and can be used under CC BY SA 3.0 license.
